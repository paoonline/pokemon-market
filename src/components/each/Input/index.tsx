...
export const InputWithIcon = (props: InputAble): JSX.Element => {
    return (
        <div className="relative text-white focus-within:text-white">
            ...
            <input type="search" name="q" className="input-with-icon-border py-2 text-sm text-white rounded-md pl-8 pr-2 focus:outline-none  focus:text-white" placeholder="Search by Name" autoComplete="off" />
        </div>
    )
}